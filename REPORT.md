...
Bias was another concern because AI suggestions can favour common textbook structures or unnecessarily complex solutions. I reduced this risk by comparing suggestions with the coursework brief and choosing simpler designs where they were more suitable, such as local turn switching instead of networking. I also considered licensing and intellectual property by writing my own game code, using standard Java, Maven, and JUnit dependencies, and referencing sources rather than copying an external project implementation.
